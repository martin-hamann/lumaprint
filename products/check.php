...
<style>
    ...
    <div id="text">
        <p class=text>Et 44x100 cm. farveprint klæbet på en 5 mm. tyk pur-skumplade. Farven kan efterligne dit logo eller som du
            ønsker. Mail os dit logo og info, så mailer vi en korrektur tilbage med et par layout forslag. Eller mail
            din egen design/layout som PDF fil til os.
    ...
    <div class="container d-flex justify-content-center kontakt-os-knap"><button type="button"
