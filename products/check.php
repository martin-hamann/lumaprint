...
<body>
    ...
    <div class="container d-flex justify-content-center kontakt-os-knap"><button type="button" class="btn btn-lg px-4 me-md-2 hero-button-1 ">Kontakt Os</button> </div>
</body>
</html>
