...
<head>
    ...
    <div class="check-container container">
        ...
        <div class="text-container text-center">
            <p class="text">Et 44x100 cm. farveprint klæbet på en 5 mm. tyk pur-skumplade. Farven kan efterligne dit
                logo eller som du ønsker. Mail os dit logo og info, så mailer vi en korrektur tilbage med et par layout
                forslag. Eller mail din egen design/layout som PDF fil til os.
        ...
        <p class="text-center mt-3 text">Lyder det som noget for dig så kontakt os for et uforpligtende tilbud <br>
