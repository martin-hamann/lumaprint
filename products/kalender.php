...
<div class="kalender-main-content">
    ...
    <p class="text"> Kalender med dit logo og layout eller spiral kalender med dine billeder. <br> Farve printes med 6 måneder på
        hver side. </p>

    <div class="box-container">
        <div class="box">
            <h3 class="headline">A5 Bordkalender</h3>
        ...
        <div class="box">
            <h3 class="headline">A4 Kalender</h3>
