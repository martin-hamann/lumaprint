...
<div class="container-fluid pladeprint-container">
    ...
    <div class="row mx-auto d-flex justify-content-center">
        <div class="col-12 col-md-6">
            <table class="table table-bordered border-dark text-center mb-4">
                <thead>
                    <tr>
                        <td colspan="7" class="bg-dark text-light">Bløde plader til indedørs brug. 4+0 enkelt side
                            print.</td>
                    </tr>
                    <tr>
                        <th>Størrelse</th>
    ...
    <div class="row mx-auto d-flex justify-content-center">
        <div class="col-12 col-md-6">
            <table class="table table-bordered border-dark text-center mb-4">
                <thead>
                    <tr>
                        <td colspan="7" class="bg-dark text-light">Bløde plader til indedørs brug. 4+4 dobbelt side
                            print.</td>
                    </tr>
                    <tr>
                        <th>Størrelse</th>
    ...
    <div class="row mx-auto image-box">
        <div class="d-flex justify-content-center col-12 col-md-4">
            <img src="http://lumaprint.site/wp-content/uploads/2023/11/PVC-plade.jpg" alt="print på pvc-plade">
        </div>
        <div class="d-flex justify-content-center col-12 col-md-4">
            <img src="http://lumaprint.site/wp-content/uploads/2023/11/PladePrint.jpg" alt="print på plade">
        </div>
        <div class="d-flex justify-content-center col-12 col-md-4">
            <img src="http://lumaprint.site/wp-content/uploads/2023/11/Bolgepap.jpg" alt="print på bølgepap">
        </div>
    </div>
