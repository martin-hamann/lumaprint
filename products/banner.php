...
<div class="container">
    <div class="header mb-4 py-4">
        <h2 class="banner-headline headline">Banner</h2>
    </div>
    <div class="row image-container d-flex justify-content-center">
        <div class="col-md-3 image-box">
            ...
            <p class="banner-text">Outdoor eller indoor B1 pressing banner.
                Print på en side.</p>
        </div>
        <div class="col-md-3 image-box">
            <img src="http://lumaprint.site/wp-content/uploads/2023/11/Mesh.jpg" alt="Mesh">
            <h4 class="Headline">Mesh banner</h4>
            <p class="banner-text">Outdoor banner med små huller som tillader vinden at trænge igennem. Det er velegnet
        ...
        <div class="col-md-3 image-box">
            ...
            <h4 class="banner-sub-headline headline">Stof banner</h4>
            <p class="banner-text">Outdoor og indoor B1 brændhæmmende fleksibel tekstil banner. Kan foldes sammen til
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 mx-auto center-text text-danger ">
                <table class="table table-bordered border-dark text-center mb-">
                    <thead>
